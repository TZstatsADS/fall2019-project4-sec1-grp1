...
# =============================================================================
        self._sim = pairwise_distances(item_latent.T,metric='cosine')
    ...
    def KNN(self,k=5,test_point=None):
        ...
        k_neighbors_class = np.argsort(self._sim[test_point])[1:1+self._k]
        ...
        return np.mean(r_ij[k_neighbors_class,:],axis=0)
